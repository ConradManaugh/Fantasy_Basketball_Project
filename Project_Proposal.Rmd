...
```{r}
Name=c("Lebron James", "Lebron James","Derrick Rose","Derrick Rose")
Team=c("CLE","CLE","CHI","CHI")
Age=c(19,33,20,21)
year=c(2003,2017,2008,2009)
points=c(20.9,27.5,16.8,20.8)
offrebounds=c(1.3,1.2,1.2,.8)
defrebounds=c(4.2,7.5,2.7,2.9)
steals=c(1.6,1.4,.8,.7)
fouls=c(1.9,1.6,1.5,1.2)
turnovers=c(3.5,4.2,2.5,2.8)
fgperc=c(.417,.542,.475,.489)
ftperc=c(.754,.731,.788,.766)
BaseData=data.frame(Name,Team,Age,year,points,offrebounds,defrebounds,steals,fouls,turnovers,fgperc,ftperc)
BaseData
```


An example of the dataset that we will use. 


![Sketch of Plan](img/plan_sketch.JPG)