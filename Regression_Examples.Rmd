...
Fun_FG=function(Age,Name){
  if(Name=="Aaron Brooks"){
    coef=0
  }else{
  

    coef=as.numeric(fit1$coefficients[(which(All_Season_Stats==Name))+2])
  }
  -1.900e+03+(-3.069e+00*Age*Age)+162.52126*Age+coef
