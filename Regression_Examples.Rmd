...
```{r graphs}
ggplot(DatSet01[1:6,],mapping=aes(x=Age, y=FG,color="Actual"))+geom_line(mapping=aes(x=Age,y=pred_FG01,color="Predicted Curve"))+geom_point(mapping=aes(x=Age,y=pred_FG01,color="Predicted"))+geom_point()
```
